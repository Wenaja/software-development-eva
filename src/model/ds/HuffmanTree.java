...
public class HuffmanTree {
	...
	/*
	 * Den Text in Buchstaben zerlegen, deren Haufigket zaehlen und diese Daten
	 * (Buchstabe + Gewicht) in Liste einfuegen.
	 * 
	 */
	...
	private List<BinTree> getStepToTree(List<BinTree> sorted_billets) {
		...
		BinTree tree = new BinTree(t1, t1.getRootLetter() + t2.getRootLetter(), t1.getRootWeight() + t2.getRootWeight(),
				t2);
